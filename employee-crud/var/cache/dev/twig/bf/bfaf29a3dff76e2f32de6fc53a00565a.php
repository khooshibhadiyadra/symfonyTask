...
class __TwigTemplate_d34ede4a913f9987bdb2278ac5e7df8f extends Template
{
...
.container {
  ...
  padding: 20px;
    ...
    <form method=\"post\" >
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 45, $this->source); })()), "user", [], "any", false, false, false, 45)) {
            ...
            // line 47
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 47, $this->source); })()), "user", [], "any", false, false, false, 47), "userIdentifier", [], "any", false, false, false, 47), "html", null, true);
            yield ", <a href=\"";
  ...
  <div class=\"container\">
     <div class=\"row\">
        ...
        // line 56
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 56, $this->source); })()), "html", null, true);
...
.container {
  ...
  <div class=\"container\">
     <div class=\"row\">
        <label for=\"username\">Email</label>
        <input  class=\"form-control\" type=\"email\" value=\"{{ last_username }}\" name=\"_username\" id=\"username\" class=\"form-control\" autocomplete=\"email\" required autofocus>
    </div>
  <div class=\"row\">
        <label for=\"password\">Password</label>
        <input class=\"form-control\" type=\"password\" name=\"_password\" id=\"password\" class=\"form-control\" autocomplete=\"current-password\" required>
    ...
    <div >
        ...
        <button class=\"btn btn-primary\" type=\"submit\">
            ...
            <div class=\"mb-3\">
        New user? <a href=\"{{ path('app_register') }}\">Register</a>
    </div>
</div>
</div>
...
{% endblock %}
", "security/login.html.twig", "/var/www/html/symfonyTask/employee-crud/templates/security/login.html.twig");
    }
}
